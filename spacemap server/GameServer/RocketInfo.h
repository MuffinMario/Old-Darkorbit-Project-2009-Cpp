...
public:
	...
	CRocketInfo(std::string name, damage_t dmg, dist_t maxDistance, rockettype_t type) :
		m_name(name),
		m_dmg(dmg),
	...
	dist_t getMaxDistance() { return m_maxDistance; }
	rockettype_t getType() { return m_type; }
	std::string getName() { return m_name; }

	void setDamage(damage_t dmg) { m_dmg = dmg; }
	void setMaxDistance(dist_t dist) { m_maxDistance= dist; }
