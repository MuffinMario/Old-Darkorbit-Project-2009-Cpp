...
namespace Constants {
	...
	namespace Received {
		...
		*/
		...
		const std::string SPECIAL_CLOAK				= "CLK";
		const std::string SPECIAL_REPBOT			= "ROB";
		const std::string SPECIAL_WIZ				= "WIZ";
		const std::string SPECIAL_CHANGECONFIG		= "CFG";
		...
		const std::string COLLECT_BOX				= "x";
	...
	namespace Send {
		...
		const std::string SPECIAL_CHANGECONFIG		= "S|CFG";
		...
		const std::string RECEIVELOOT				= "y";
