...
#define GAMESERVER_CONFIG_FILENAME "gameserver_config.cfg"
#define POLICYSERVER_CONFIG_FILENAME "policyserver_config.cfg"
...
typedef int ore_t;
typedef int pos_t;
typedef pos_t dist_t;
typedef unsigned short speed_t;
typedef int map_t;
typedef unsigned long long id_t;
typedef unsigned int cfg_t;
